...
NUM_TAXIS = 300
abm_VANET_dataset_filename = 'sf_vanet_data_dict_300taxis_0.5hrs_v2vdata_14feb.pickle'
abm_positions_dataset_filename = 'sf_vanet_node_loc_dict_300taxis_0.5hrs_v2vdata_14feb.pickle'

#NUM_TAXIS = 2000
#abm_VANET_dataset_filename = 'sf_vanet_data_dict_2000taxis_0.5hrs_v2vdata_14feb.pickle'
#abm_positions_dataset_filename = 'sf_vanet_node_loc_dict_2000taxis_0.5hrs_v2vdata_14feb.pickle'
...
NUM_TAXIS = 2000
DATE = 15
abm_VANET_dataset_filename = ('Roma_vanet_data_dict_%staxis_0.5hr_v2vdata_%sfeb.pickle' % (NUM_TAXIS, DATE))
abm_positions_dataset_filename = ('Roma_vanet_node_loc_dict_%staxis_0.5hr_v2vdata_%sfeb.pickle' % (NUM_TAXIS, DATE)) 

#NUM_TAXIS = 2000
#abm_VANET_dataset_filename = 'Roma_vanet_data_dict_2000taxis_0.5hr_v2vdata_13feb.pickle'
#abm_positions_dataset_filename = 'Roma_vanet_node_loc_dict_2000taxis_0.5hr_v2vdata_13feb.pickle'
...
for timestamp in ts_index:
    ...
    LCC_diameter_list.append(nx.diameter(G_lcc))
    ...
    LCC_edge_density_list.append((0.5*num_LCC_edges_list[-1])/(num_LCC_nodes_list[-1]*(num_LCC_nodes_list[-1]-1)))
...
for i in range(len(Connected_Components_list)):
    ...
    hist, bin_edges = np.histogram(Connected_Components_list[i], cc_bins)

    cumsum_hist += hist


plt.figure()
plt.plot(bin_edges[1:], cumsum_hist/len(Connected_Components_list),'--or')
